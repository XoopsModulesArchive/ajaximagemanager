...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../uploads/ajaximagemanager/uploaded/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../uploads/ajaximagemanager/uploaded/');	//accept relative path only
